      ...
      <div className="container">
        ...
        <div className="footer__content">
          <nav className="footer__nav">
            <ul className="footer__nav__catygories">
              <li className="footer__nav__catygory">
                <h3 className="footer__nav__catygory__title">Features</h3>
                <ul className="footer__nav__catygory__links">
                  <li>
                    <a href="#" className="footer__nav__catygory__link">
                      Link Shortening
                    </a>
                  </li>
                  <li>
              ...
              <li className="footer__nav__catygory">
                <h3 className="footer__nav__catygory__title">Resources</h3>
                <ul className="footer__nav__catygory__links">
                  <li>
                    <a href="#" className="footer__nav__catygory__link">
                      Blog
              ...
              <li className="footer__nav__catygory">
                <h3 className="footer__nav__catygory__title">Company</h3>
                <ul>
                  <li>
                    <a href="#" className="footer__nav__catygory__link">
                      About
          ...
          <ul className="social__media">
            <li>
              <a href="" className="social__media__link">
